...
import { getBackendErrorBody, getBackendErrorStatus, isBackendConfigured, voidPortalInvoice } from "@/lib/api";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await voidPortalInvoice(tenantContext.tenantId, id, {
