...
import { getBackendErrorBody, getBackendErrorStatus, isBackendConfigured, issuePortalInvoice } from "@/lib/api";
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const result = await issuePortalInvoice(tenantContext.tenantId, id, {
