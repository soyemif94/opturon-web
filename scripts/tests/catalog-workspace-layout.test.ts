...
assert.match(manager, /Importar archivo/);
assert.match(manager, /Carga por texto/);
assert.match(manager, /Carga rápida por texto/);
assert.match(manager, /Excel, CSV o TXT/);
assert.match(manager, /Pegá varias líneas/);
assert.match(manager, /renderCatalogEditorWorkspace\(\)/);
assert.match(manager, /scrollToSection\("catalog-workspace"\)/);
assert.match(manager, /scrollToSection\("catalog-file-import"\)/);
