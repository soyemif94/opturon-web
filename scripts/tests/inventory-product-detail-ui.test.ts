...
assert(panel.includes("buildLotWriteoffPayload"), "product detail must support manual writeoff semantics");
...
assert(panel.includes("Confirmar baja manual"), "product detail must expose manual writeoff confirmation");
