...
export function Composer({
  ...
  return (
    <div className="sticky bottom-0 rounded-[22px] border border-[color:var(--border)] bg-card/95 p-2.5 shadow-[0_-12px_30px_rgba(0,0,0,0.12)] backdrop-blur">
      ...
      <div className="flex gap-2.5">
        <textarea
          ...
          rows={3}
          className="w-full rounded-[18px] border border-[color:var(--border)] bg-bg px-3 py-2.5 text-sm outline-none focus:border-brand/40"
        ...
        <button
          ...
          className="self-end rounded-[18px] bg-brand px-4 py-2.5 text-sm font-semibold text-white disabled:opacity-40"
        >
          Enviar
        </button>
      </div>
