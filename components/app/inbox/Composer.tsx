...
export function Composer({
  ...
  return (
    <div className="sticky bottom-0 rounded-[24px] border border-[color:var(--border)] bg-card/95 p-2.5 shadow-[0_-14px_32px_rgba(0,0,0,0.14)] backdrop-blur">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            <button
              ...
              className="rounded-full border border-[color:var(--border)] bg-surface/80 px-3 py-1.5 text-xs text-muted hover:text-text"
            >
              Templates
            </button>
            {openTemplates ? (
          ...
          <span className="text-[11px] text-muted">Enter para enviar · Shift+Enter para nueva línea</span>
        </div>
      </div>
      ...
      <div className="flex gap-2.5">
        ...
        <button
          ...
          className="self-end rounded-[20px] bg-brand px-4 py-2.5 text-sm font-semibold text-white shadow-[0_16px_30px_rgba(176,80,0,0.24)] disabled:opacity-40"
        >
          Enviar
        </button>
      </div>
