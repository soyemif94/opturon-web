    ...
    <div className={cn("flex", outbound ? "justify-end" : "justify-start", system ? "justify-center" : "")}>
      <div
        className={cn(
          ...
          outbound && "border border-[color:var(--whatsapp-accent-border)] bg-[linear-gradient(135deg,rgba(24,100,52,0.98),rgba(16,82,40,0.98))] text-white [[data-app-theme=light]_&]:border-[#803000] [[data-app-theme=light]_&]:bg-[linear-gradient(135deg,#B05000,#803000)]",
          !outbound && !system && "border border-[color:var(--border)] bg-[linear-gradient(180deg,rgba(36,36,36,0.95),rgba(24,24,24,0.98))] text-text [[data-app-theme=light]_&]:border-[color:rgba(23,23,23,0.16)] [[data-app-theme=light]_&]:bg-none [[data-app-theme=light]_&]:bg-white [[data-app-theme=light]_&]:text-[#171717] [[data-app-theme=light]_&]:shadow-[0_8px_20px_rgba(23,23,23,0.06)]",
      ...
      >
        <div
          className={cn("mb-1.5 flex items-center gap-1.5 text-[10px] uppercase tracking-[0.16em]", outbound && "[[data-app-theme=light]_&]:!text-white/75", !outbound && !system && "[[data-app-theme=light]_&]:!text-[#525252]")}
        ...
        <p
          className={cn("mt-1.5 flex items-center justify-end gap-1 text-[10px]", outbound && "[[data-app-theme=light]_&]:!text-white/75", !outbound && !system && "[[data-app-theme=light]_&]:!text-[#525252]")}
          style={{ color: senderTone }}
        >
