...
export function HomeHero() {
  ...
  return (
    ...
    >
      ...
      <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:gap-8 xl:grid-cols-[minmax(0,0.84fr)_minmax(0,1.16fr)] xl:gap-12">
        <div className="max-w-2xl space-y-7 lg:max-w-[28rem] xl:max-w-[35rem]">
